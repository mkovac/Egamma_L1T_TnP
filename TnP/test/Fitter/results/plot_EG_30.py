...
plots[-1].name = "turnon_plot_30"
plots[-1].xRange = (5,1000)
#plots[-1].legendPosition = (0.6,0.2,0.9,0.4)
plots[-1].legendPosition = (0.6,0.2,0.9,0.4)

plots.append(TurnOnPlot.TurnOnPlot())
plots[-1].name = "turnon_diff_plot_30"
plots[-1].xRange = (5,1000)
#plots[-1].legendPosition = (0.6,0.2,0.9,0.4)
plots[-1].legendPosition = (0.45,0.2,0.9,0.3)


inputFile = ROOT.TFile.Open("./TestTurnOn/fitOutput_30.root")
...
turnon = TurnOnPlot.TurnOn(Name="Stage2", Histo=histo, Fit=None,
